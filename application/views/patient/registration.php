    ...
    <div class="login_wrapper">
        <div id="register">
            <section class="login_content">
                <form action="<?php echo base_url() ?>patient/Patient_reg_controllers/patient_registration"
                      method="post">
                ...
                <div class="separator">
                    <p class="change_link">Already a member ?
                        <a href="<?php echo base_url() ?>Welcome/patient_login" class="to_register"
                           style="color: #00A000"> Log in </a>
                    </p>
                    <div class="clearfix"></div>
                    <br/>
                    <div>
                        <h1><i class="fa fa-heartbeat"></i><a href="<?php echo base_url() ?>Welcome"> Medical Life
                                !! </a></h1>
