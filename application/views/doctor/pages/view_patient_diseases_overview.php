	...
	<div class="x_panel">
		...
		<div class="x_content">
			...
			<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
				...
				<?php
				$count = 1;
				foreach ($patient_diseases_info as $information) {
					?>
					...
					<tr>
						...
						<td>
							...
							if ($status) :
								?>
								<span class="label label-danger">Diseases I Have</span>
								<?php
							else :
								?>
						...
						<td>
							<a href="<?php echo base_url() ?>doctor/Doctor_view_controllers/patient_doctor_info/<?php echo $information->diseases_id ?>"
							   class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a></td>
						<td>
							<a href="<?php echo base_url() ?>doctor/Doctor_view_controllers/patient_prescription_info/<?php echo $information->diseases_id ?>"
							   class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a></td>
						<td>
							<a href="<?php echo base_url() ?>doctor/Doctor_view_controllers/patient_report_info/<?php echo $information->diseases_id ?>"
							   class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a></td>
